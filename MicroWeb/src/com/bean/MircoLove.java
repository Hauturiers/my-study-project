...
public class MircoLove {
	...
	private int mircolove_target_amount;
	private int mircolove_raise_amount = 0;
	...
	public int getMircolove_target_amount() {
		return mircolove_target_amount;
	}

	public void setMircolove_target_amount(int mircolove_target_amount) {
		this.mircolove_target_amount = mircolove_target_amount;
	}

	public int getMircolove_raise_amount() {
		return mircolove_raise_amount;
	}

	public void setMircolove_raise_amount(int mircolove_raise_amount) {
